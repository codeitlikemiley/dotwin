" Windows 10 Neovim Set Up With VSCODE
...
" Install Pugged
"  Copy and Paste this to Windows Terminal
"       md ~\AppData\Local\nvim\autoload
...
" Configure Our Neovim Config

" Finally Run
" :PlugInstall

" END OF WINDOWS 10 NEOVIM SET UP WITH VSCODE


" Function to Conditionally Load Plugins
function! Cond(cond, ...)
